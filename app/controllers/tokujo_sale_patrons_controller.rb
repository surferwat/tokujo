class TokujoSalePatronsController < ApplicationController
  ...
  def create
    ...
    redirect_to new_tokujo_sale_order_path(tokujo_id: tokujo.id, patron_id: user_patron.id, checkout_session_id: params[:checkout_session_id], size: params[:size], total_price_with_tax: params[:total_price_with_tax])
    return
