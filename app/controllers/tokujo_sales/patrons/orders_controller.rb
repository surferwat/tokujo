class TokujoSales::Patrons::OrdersController < ApplicationController
  ...
  def create
    ...
    if checkout_session.order_id != nil
      ...
      redirect_to tokujo_sales_patrons_orders_card_setups_path(tokujo_id: order.tokujo_id, patron_id: order.user_patron_id, id: order.id, checkout_session_id: checkout_session.id)
      return
    end
