...
export default class extends Controller {
  connect() {
    ...
    const intent_type = this.element.getAttribute("data-intent-type")
    ...
    async function handleSubmit(e) {
      ...
      switch (intent_type) {
        case "payment_intent":
          error = await stripe.confirmPayment(params);
          break;
        case "setup_intent":
          error = await stripe.confirmSetup(params);
          break;
        default:
          // TODO: Unexpected behavior. Write to log.
          console.log("Invalid intent type.")
      }
