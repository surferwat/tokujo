...
class TokujoSales::Patrons::Orders::CardSetupsControllerTest < ActionDispatch::IntegrationTest
  setup do 
  ...
  test "should get index" do
    get tokujo_sales_patrons_orders_card_setups_path(@tokujo.id, @user_patron.id, @order.id, checkout_session_id: @checkout_session.id)
    assert_response :success
  end

  test "should not get index without checkout_session_id" do
    get tokujo_sales_patrons_orders_card_setups_path(@tokujo.id, @user_patron.id, @order.id, checkout_session_id: "")
